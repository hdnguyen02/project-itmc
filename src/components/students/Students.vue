<template>
            ...
            <table>
                ...
                <tr id="std" v-for="(student,index) in listRender" :key="index" >
                    ...
                    <td>
                     ...
                     <td>
                        <button @click="modalDelete(student.id)" class="btn-table backgroundRed">Xóa</button>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div id="removeStd" >
      <div id="modalRes"> 
          ...
          <div >
            <button @click="deleteOke" style="background-color: rgb(231, 74, 59)" class="btn-delete">Xóa</button>
            <button @click="deleteCancel"  style="background-color: rgba(47, 86, 200,0.9)"  class="btn-delete">Hủy</button>
          </div>
      </div>
...
export default {
    ...
    methods:{
        ...
        deleteOke () {
            ...
            fetch (url,options) // sau khi xóa song thực hiện render lại  
            this.loader();
            // reset lấy cái gần nhần gần nhất.
            this.deleteCancel(); 
