  ...
  <div id="students" class="container-fluid">
    <div id="content">
      ...
      <div id="table">
        ...
        <div
          class="row no-gutters border-top border-bottom row-custom"
          v-for="(student, index) in listRender"
          :key="index"
        >
          ...
          <div class="col-1 border-left border-right">
            <!-- Xem chĩnh sữa xóa -->
            <router-link
              class="btn btn-info min-width-60px"
          ...
          <div class="col-1 border-left border-right">
            <router-link
              class="btn btn-primary min-width-60px"
          ...
          <div class="col-1 border-left border-right">
            <button
              @click="
                confirm(student.id, student.fullName, student.maSV, students)
              "
              class="btn btn-danger min-width-60px"
            >
              Xóa
            </button>
          </div>
      ...
      <div class="modal-delete">
        <div class="content-delete">
          ...
          <div class="footer-delete">
            <button class="btn btn-secondary cancelDelete radius-0px">
              Hủy
            </button>
    ...
    showStudents: {
      ...
      handler(newShow) {
        ...
        tableNode.style.minHeight = `${
          (parseInt(newShow.length, 10) + 1) * 50
        }px`;
        tableNode.style.maxHeight = `${
          (parseInt(newShow.length, 10) + 1) * 100
        }px`;
    ...
    confirm(id, name, ms, arrStudent) {
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          arrStudent.forEach(function (student, index, arr) {
            if (student.id == id) {
              arr.splice(index, 1);
            }
          });
